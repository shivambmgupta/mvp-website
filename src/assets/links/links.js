...
const AboutDeveloper = {
    ...
    Developer: {
        ...
        resume: `https://drive.google.com/file/d/1O3NMgjSMWP0oci_N8wdH3nVR5I3QvRPE/view?usp=sharing`,
        social_medias: [
            {
            ...
            {
                url: `https://dev.to/shivambmgupta`,
                icon: `https://raw.githubusercontent.com/peterthehan/peterthehan/master/assets/dev-dot-to.svg`,
                description: `${Developer.DEVELOPER} | Dev Community` // META Data | alt text
            } 
        ]
    }  
}
